      ...
      >
        ...
        <div className="flex flex-col gap-y-1 px-5 pb-4 items-start w-full">
          ...
          <p className="text-sm text-muted-foreground">
            Connect to multiple banking providers and financial services in
            minutes.
          </p>
        </div>
      </motion.div>
  ...
  const logs = [
    {
      ...
      message: "Reconciling bank transactions...",
      icon: (
        <div className="h-8 w-8 rounded-full bg-blue-500 flex items-center justify-center">
          <ArrowLeftRightIcon className="h-5 w-5 text-white" />
        </div>
    ...
    },
    {
      ...
      message: "Matching invoices with payments...",
      icon: (
        <div className="h-8 w-8 rounded-full bg-green-500 flex items-center justify-center">
    ...
    },
    {
      ...
      message: "AI detected duplicate payment",
      icon: (
    ...
    },
    {
      ...
      message: "Updating cash flow forecast...",
      icon: (
        <div className="h-8 w-8 rounded-full bg-purple-500 flex items-center justify-center">
    ...
    <div className="p-0 h-full overflow-hidden border-b lg:border-b-0 lg:border-r">
      ...
      >
        ...
        <div className="flex flex-col gap-y-1 px-5 pb-4 items-start w-full">
          ...
          <p className="text-sm text-muted-foreground">
            Track transactions, reconciliation, and AI-powered anomaly
            detection.
          </p>
        </div>
      </motion.div>
  ...
  return (
    <div className="p-0 min-h-[500px] lg:min-h-fit overflow-hidden border-b lg:border-b-0 -z-0">
      <div className="relative flex flex-col gap-y-5 items-center justify-between h-full w-full">
        ...
        <div className="flex flex-col gap-y-1 px-5 pb-4 items-start w-full">
          <h2 className="font-semibold tracking-tight text-lg">
            Unified Financial Tools
          </h2>
          <p className="text-sm text-muted-foreground">
            Manage invoicing, payments, and reporting in one place.
          </p>
        </div>
      </div>
    </div>
